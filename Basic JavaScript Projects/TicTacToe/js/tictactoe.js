...
function placeXorO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if(activePlayer === "O") {
            ...
            disableClick();
            //This function waits 1 second before computer places images and enables click.
...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //If the 3 variables we pass are all include in our array true is
...
function drawWinLine (coordX1, coordY1, coordX2, coordY2) {
    //This line accesses our html cancas element.
    ...
    let x1 = coordX1,
        ...
        y1 = coordY1,
        //This line indicateds where the end of a lines x axis is.
        x2 = coordX2,
...
function animateLineDrawing() {
    ...
    //This is necessary for the 6, 4, 2 win conditon
    if (x1 <= x2 && y1 >= y2) {
        if (x < x2) { x += 10; }
        if (y > y2) { y -= 10; }
        if (x >= x2 && y <= y2) { cancelAnimationFrame(animationLoop); }
